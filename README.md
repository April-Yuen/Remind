...
<a href="#">
  <img height="28px" src="# (A link to our discord.) " alt="Discord (A link to our Group? Or a special discord.)"/>
</a>
...
<div align="center">
  ...
  <br/>
  <br/>
  <a href="https://github.com/April-Yuen/Remind/wiki">Project Wiki</a>
  ·
...
- Complete and store `.env` file in the `server/config` folder
    - [(See .env template setup instructions)](https://github.com/April-Yuen/Remind/wiki/02---Onboarding#development-machine-setup) (We'll need to create this... )
- `npm install` in the root folder, which installs the required dependencies.
- And, `npm run dev` in the root folder. 
<!-- This starts the front-end and back-end in one terminal. -->
...
<br>
<!--  Do we want to add a help section to assist people launching the app? Will we add a channle in the discord to discuss with them? Or is this unneccassary for this project?
### 🤔 <strong>Still having troubles?</strong>
You can check out our [New Developer Onboarding](https://github.com/April-Yuen/Remind/wiki/02---Onboarding) in our [wiki](https://github.com/April-Yuen/Remind/wiki).

<!-- You can also join the discussion in the [Remind Discord channel](https://discord.com/channels/735923219315425401/1038482732633825442) within [100Devs](https://leonnoel.com/100devs/). -->
...
<br>
<!-- More shameless theft of an awesome readme. Do we want to include Improve links? 
## Help us improve Remind!
<
<em>Remind</em> is a community-driven open source project backed by 100devs students. Whether you are helping us fixing bugs, proposing new feature, improving our documentation or spreading the word - <strong>All contributions are welcome.</strong>
...
* Visit the [Issues tab](https://github.com/April-Yuen/Remind/issues) to request an issue or to open a new issue;
* You can also convert a "draft todo" to an issue on the [MVP Tasks Project Board.](https://github.com/users/April-Yuen/projects/1/views/1) -->
